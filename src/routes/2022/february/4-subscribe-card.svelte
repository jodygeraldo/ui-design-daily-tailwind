...
<div class="theme grid min-h-screen place-items-center">
  <div class="container mx-auto px-8 py-4">
    <div
      class="relative mx-auto max-w-lg rounded-xl bg-gradient-to-br from-[#f6f8ff] to-[#E7EAFE] p-10 lg:rounded-3xl lg:p-20"
    >
      <div
      ...
      <div class="space-y-4 lg:space-y-6 xl:space-y-8">
        ...
        <div class="space-y-2">
          <div class="flex items-center gap-3">
            <button
              class="h-8 w-8 shrink-0 rounded border-2 border-[#8A93C3]"
            />
