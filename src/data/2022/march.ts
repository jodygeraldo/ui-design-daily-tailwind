...
const list: ItemType[] = [
  ...
  },
  {
    ...
    builtOn: formattedDate(7, 4, 2022, 2),
  },
  {
    id: 1578,
    title: 'Timeline UI Design',
    date: formattedDate(23, 3, 2022).formatted,
    linkOriginal:
    ...
    builtOn: formattedDate(7, 4, 2022, 1),
  },
  {
    id: 1577,
  ...
  },
  {
    ...
    builtOn: formattedDate(6, 4, 2022, 2),
  },
  {
    id: 1575,
    title: 'Product Info UI Design',
    date: formattedDate(18, 3, 2022).formatted,
    linkOriginal:
    ...
    builtOn: formattedDate(6, 4, 2022, 1),
  },
  {
    id: 1574,
    title: 'Buy Subscription Section',
    date: formattedDate(17, 3, 2022).formatted,
    linkOriginal:
    ...
    builtOn: formattedDate(5, 4, 2022, 4),
  },
  {
    id: 1573,
    title: 'Reviews',
    date: formattedDate(16, 3, 2022).formatted,
    ...
    builtOn: formattedDate(5, 4, 2022, 3),
  },
  {
    id: 1572,
    title: 'Shopping Cart',
    date: formattedDate(15, 3, 2022).formatted,
    linkOriginal:
    ...
    builtOn: formattedDate(5, 4, 2022, 2),
  },
  {
    id: 1571,
    title: 'Pick Up In Store Card',
    date: formattedDate(14, 3, 2022).formatted,
    linkOriginal:
  ...
  },
  {
    ...
    builtOn: formattedDate(3, 4, 2022, 3),
  },
  {
    id: 1565,
    title: 'Product Review Modal',
    date: formattedDate(4, 3, 2022).formatted,
    linkOriginal:
    ...
    builtOn: formattedDate(3, 4, 2022, 2),
  },
  {
    id: 1564,
    title: 'Details Card',
    date: formattedDate(3, 3, 2022).formatted,
    linkOriginal:
    ...
    builtOn: formattedDate(3, 4, 2022, 1),
  },
  {
    id: 1563,
    title: 'Stores List',
    date: formattedDate(2, 3, 2022).formatted,
    linkOriginal:
  ...
  },
  {
    id: 1562,
    title: 'Price Card',
    date: formattedDate(1, 3, 2022).formatted,
    linkOriginal:
...
export const pendingList = [
  {
    id: 1567,
    title: 'Analytics',
    date: formattedDate(8, 3, 2022).formatted,
    linkOriginal:
  ...
  },
  {
    id: 1568,
    title: 'Statistics',
    date: formattedDate(9, 3, 2022).formatted,
    linkOriginal:
